...
function spectrogram_edit_para_Callback(hObject, eventdata, handles)
% hObject    handle to spectrogram_edit_para (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of spectrogram_edit_para as text
%        str2double(get(hObject,'String')) returns contents of spectrogram_edit_para as a double


% --- Executes during object creation, after setting all properties.
function spectrogram_edit_para_CreateFcn(hObject, eventdata, handles)
% hObject    handle to spectrogram_edit_para (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function spectrogram_edit_channel_Callback(hObject, eventdata, handles)
% hObject    handle to spectrogram_edit_channel (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of spectrogram_edit_channel as text
%        str2double(get(hObject,'String')) returns contents of spectrogram_edit_channel as a double


% --- Executes during object creation, after setting all properties.
function spectrogram_edit_channel_CreateFcn(hObject, eventdata, handles)
% hObject    handle to spectrogram_edit_channel (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
